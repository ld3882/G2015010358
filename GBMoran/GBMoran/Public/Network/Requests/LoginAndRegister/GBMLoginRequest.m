...
@interface GBMLoginRequest()<NSURLConnectionDataDelegate>

@end

@implementation GBMLoginRequest

- (void)sendLoginRequestWithUserName:(NSString *)userName password:(NSString *)password delegate:(id<GBMLoginRequestDelegate>)delegate
{
    NSString *gbid = @"";
